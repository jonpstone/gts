	...
	render() {
		return (
			<Container style={{ marginTop: '2em', fontSize: '1.2em' }}>
				...
				<Header as='h2' textAlign='center' style={{ fontSize: '2em', marginBottom: '1.5em' }}>First Aid at Work</Header>

				<Container textAlign='center'>
					<Button inverted color='blue' size='huge' onClick={this.handleOnClick} style={{ marginRight: '1.2em'}}>
						Emergency First Aid at Work &nbsp;
						<Icon name='angle down'/>
					</Button>
					<Button inverted color='blue' size='huge' onClick={this.handleOnClick}>
						First Aid at Work Requalification &nbsp;
						<Icon name='double angle down'/>
					</Button>
				</Container>

				<Divider horizontal style={{ margin: '5em 0' }}>Level 3 First Aid at Work &nbsp; | &nbsp; 3 day course</Divider>
				...
				<Grid>
					<Grid.Row>
						This course runs over 18 hours and is spread over at least 3 days. Ideally, the course should
						be run over three consecutive days, but we have the flexibility to accommodate your 
						specific needs if you so desire providing it is completed within 10 weeks of starting 
						the course and the training sessions last for a minimum of two hours.
					</Grid.Row>
				</Grid>
				...
				<Grid divided stackable columns='equal' style={{ margin: '5em 0' }}>
					<Grid.Row>
						<Grid.Column style={{ padding: '0 2em 0 0' }}>
				...
				<Header as='h2' textAlign='center' style={{ fontSize: '2em', marginBottom: '1.5em' }}>Emergency First Aid at Work</Header>

				<Divider horizontal style={{ margin: '5em 0' }}>Level 3 Emergency First Aid at Work &nbsp; | &nbsp; 1 day course</Divider>
